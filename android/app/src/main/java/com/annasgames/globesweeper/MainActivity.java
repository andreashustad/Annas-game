package com.annasgames.globesweeper;
...
/**
 * Globesweeper as a native shell: one WebView, no network, no permissions.
 *
...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final WebViewAssetLoader assetLoader = new WebViewAssetLoader.Builder()
                .setDomain("globesweeper.localhost")
        ...
        if (savedInstanceState == null) {
            webView.loadUrl("https://globesweeper.localhost/index.html");
        } else {
