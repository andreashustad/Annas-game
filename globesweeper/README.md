...
This is a fan-made rebuild of a much-loved Android game that is no longer on the
Play Store, written from scratch as a web app that installs to an Android home
screen and runs completely offline.

![Globesweeper](docs/screenshot-board.png)
